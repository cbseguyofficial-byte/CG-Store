  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-hero p-4">
      <div className="text-center max-w-2xl mx-auto animate-fade-in">
        {/* Icon */}
        <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-destructive/80 to-french-blue shadow-glow animate-float">
          <ServerCrash className="h-12 w-12 text-white" />
        </div>

        {/* Error Code */}
        <h1 className="text-8xl md:text-9xl font-black bg-gradient-to-r from-destructive via-turquoise-surf to-sky-aqua bg-clip-text text-transparent mb-4 tracking-tight">
          500
        </h1>
        ...
        <div className="mt-16 flex justify-center gap-2">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="h-2 w-2 rounded-full bg-destructive/50"
