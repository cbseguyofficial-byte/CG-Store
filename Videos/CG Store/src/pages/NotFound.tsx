  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-hero p-4">
      <div className="text-center max-w-2xl mx-auto animate-fade-in">
        {/* Icon */}
        <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-french-blue to-turquoise-surf shadow-glow animate-float">
          <BookX className="h-12 w-12 text-white" />
        </div>

        {/* Error Code */}
        <h1 className="text-8xl md:text-9xl font-black bg-gradient-to-r from-turquoise-surf via-sky-aqua to-light-cyan bg-clip-text text-transparent mb-4 tracking-tight">
          404
        </h1>

        {/* Title */}
        <h2 className="text-2xl md:text-3xl font-bold text-light-cyan mb-6">
          Page Lost in the Syllabus
        </h2>
        ...
        <div className="mt-16 flex justify-center gap-2">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="h-2 w-2 rounded-full bg-turquoise-surf/50"
